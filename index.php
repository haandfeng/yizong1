...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
    ...
    $smarty->assign('top_goods',       get_top());           // 销售排行
    ///llx添加start
...
//    print_r(get_recommend_goods('best'));
    ...
    //热销商品广告图
    $smarty->assign('index_hot_img1',get_adv('首页热卖-大图一'));
    $smarty->assign('index_hot_img2',get_adv('首页热卖-大图二'));
    $smarty->assign('index_hot_img3',get_adv('首页热卖-小图上'));
    $smarty->assign('index_hot_img4',get_adv('首页热卖-小图下'));
