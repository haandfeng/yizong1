<?php
 ...
 function getAccessToken($appId,$appSecret) {
    ...
    $data = json_decode(get_php_file("images/fenxiang/access_token.php"));
    ...
    if ($data->expire_time < time()) {
      ...
      if ($access_token) {
        ...
        set_php_file("images/fenxiang/access_token.php", json_encode($data));
      }
    } else {
...
$appSecret = '02705de706575a34b7f17935bda3ae22';
$app = getSignPackage($appId,$appSecret);
