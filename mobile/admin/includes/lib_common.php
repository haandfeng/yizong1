...
function build_uri($app, $params, $append = '', $page = 0, $keywords = '', $size = 0)
{
    ...
    switch ($app)
    {
        ...
        case 'group_buy':
            ...
            {
                //$uri = $rewrite ? 'group_buy-' . $gbid : 'pintuan.php?act=view&amp;id=' . $gbid;
...
function get_package_goods($package_id, $package_attr_id='')
{
    ...
    $sql = "SELECT pg.goods_id, g.goods_name, pg.goods_number, p.goods_attr, p.product_number, p.product_id
            ...
            WHERE pg.package_id = '$package_id' $sql_package_attr_id "; //有修改 by www.yshop100.com 注意最后那个 $sql_package_attr_id
    if ($package_id == 0)
    {
