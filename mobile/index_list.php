...
function get_list_goods($type = '', $rate='',$last,$size)
{
        ...
        $sql = 'SELECT cat.cat_name,g.goods_id, g.goods_name,g.click_count, g.goods_name_style, g.market_price,g.suppliers_id,ss.suppliers_desc,ss.is_exchange, g.is_intax ,g.shop_price AS org_price, g.promote_price, ' .
        ...
        $sql .= ' WHERE  g.is_on_sale = 1 AND g.is_alone_sale = 1 AND g.is_delete = 0'.$where1;
        //秒杀商品不显示
