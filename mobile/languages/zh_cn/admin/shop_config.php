...
$_LANG['cfg_name']['is_apply_distrib'] = '是否需要申请成为微分销';
$_LANG['cfg_range']['is_apply_distrib'][1] = '是';
$_LANG['cfg_range']['is_apply_distrib'][0] = '否';
...
$_LANG['cfg_name']['deposit_least_rate'] = '提现手续费的费率';
$_LANG['cfg_desc']['deposit_least_rate'] = '例：1% 请输入 0.01 设置为0时，表示不收手续费';
