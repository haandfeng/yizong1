 ...
 * $Author: liubo $
 * $Id: pintuan.php 17217 2011-01-19 06:29:08Z liubo $
*/

/* 当前页面标题及可用链接名称 */
$_LANG['pintuan_list'] = '拼团活动列表';
$_LANG['add_pintuan'] = '添加拼团活动';
$_LANG['edit_pintuan'] = '编辑拼团活动';
...
$_LANG['valid_goods'] = '销售数量';
$_LANG['current_price'] = '价格';
$_LANG['current_status'] = '状态';
$_LANG['view_order'] = '查看团长列表';
...
$_LANG['notice_restrict_amount']= '达到此数量，拼团活动自动结束。0表示没有数量限制。';
$_LANG['label_gift_integral'] = '赠送积分数：';
$_LANG['label_price_ladder'] = '拼团阶梯（建议最多3层）：';
$_LANG['notice_ladder_amount'] = '成团人数';
$_LANG['notice_ladder_price'] = '拼团价格';
...
$_LANG['error_pintuan'] = '您要操作的拼团活动不存在';
...
$_LANG['js_languages']['succeed_confirm'] = '此操作不可逆，您确定要设置该拼团活动成功吗？';
$_LANG['js_languages']['fail_confirm'] = '此操作不可逆，您确定要设置该拼团活动失败吗？';
$_LANG['button_mail'] = '发送邮件';
$_LANG['notice_mail'] = '（通知客户付清余款，以便发货）';
$_LANG['mail_result'] = '该拼团活动共有 %s 个有效订单，成功发送了 %s 封邮件。';
$_LANG['invalid_time'] = '您输入了一个无效的拼团时间。';

$_LANG['add_success'] = '添加拼团活动成功。';
$_LANG['edit_success'] = '编辑拼团活动成功。';
$_LANG['back_list'] = '返回拼团活动列表。';
$_LANG['continue_add'] = '继续添加拼团活动。';

/* 添加/编辑活动提交 */
$_LANG['error_goods_null'] = '您没有选择拼团商品！';
$_LANG['error_goods_exist'] = '您选择的商品目前有一个拼团活动正在进行！';
...
/* 删除拼团活动 */
$_LANG['js_languages']['batch_drop_confirm'] = '您确定要删除选定的拼团活动吗？';
$_LANG['error_exist_order'] = '该拼团活动已经有订单，不能删除！';
$_LANG['batch_drop_success'] = '成功删除了 %s 条拼团活动记录（已经有订单的拼团活动不能删除）。';
$_LANG['no_select_pintuan'] = '您现在没有拼团活动记录！';

/* 操作日志 */
$_LANG['log_action']['pintuan'] = '拼团商品';
