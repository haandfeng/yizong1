...
file_put_contents('20200713s.txt',date('Y-m-d H:i:s')."return1-".$var['cat_id']."=".$var['cat_name']."\r\n" , FILE_APPEND); 
        }
        return $select;
    }
    else
...
file_put_contents('20200713s.txt',date('Y-m-d H:i:s')."return2-".$value['cat_id']."=".$value['cat_name']."\r\n" , FILE_APPEND); 
        }
        return $options;
    }
}
