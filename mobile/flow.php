...
{	
    ...
    {  
		...
		$pintuansql=$pintuansql."'".$_SESSION['extension_id']."', '".$_SESSION['act_type']."', '".$_SESSION['need_people']."','".$_SESSION['need_people']."',";
...
//                    }
    ...
    {  
		...
		$pintuansql=$pintuansql." select pt_id,act_id,user_id,'".$_SESSION['user_id']."',(select user_name from ecs_users where user_id='".$_SESSION['user_id']."'),'".$_SESSION['pintuan_headimgurl']."','".$order['order_id']."',now() from ecs_pintuan where pt_id='".$_SESSION['pintuan_pt_id']."'";
