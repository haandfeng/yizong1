...
function assign_commentex( $id, $type, $page = 1, $flag = 0 )
{
		...
		$arr = array( );
		$ids = "";
		while ( ( $row = $GLOBALS['db']->fetchRow( $res ) ) ) // 修改 By  yshop100.com
		{
				$ids .= $row['comment_id'];
