...
function get_consignee_list_yshop100()
{
	...
	foreach ($consignee_list_yshop100  as $cons_key => $cons_val)
	{
				...
				$consignee_list_yshop100[$cons_key]['province'] =  get_region_info($cons_val['province']);
				$consignee_list_yshop100[$cons_key]['city'] =  get_region_info($cons_val['city']);
				$consignee_list_yshop100[$cons_key]['district'] =  get_region_info($cons_val['district']);
	}
   ...
   // else if($_SESSION['extension_code'] == 'virtual_good')
    ...
    { 			
			...
			foreach ($consignee_list_yshop100  as $cons_key => $cons_val)
			{
				...
				$consignee_list_yshop100[$cons_key]['address_short_name'] .=  sub_str($cons_val['address'],16);
				$consignee_list_yshop100[$cons_key]['address_short_name'] .=  $cons_val['zipcode'] ? (",".$cons_val['zipcode']) : "";
				$consignee_list_yshop100[$cons_key]['address_short_name'] .=  "<br>".$cons_val['mobile'];
				if ($consignee['address_id'] == $cons_val['address_id'])
				{
					$consignee_list_yshop100[$cons_key]['def_addr'] =1;
					$have_def_addr=1;
