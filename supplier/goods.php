...
/*优化了分类，去掉了之前开发的分类
if ($_REQUEST['act'] == 'get_catsel_yshop100')
{
...
$divid=$level+1;
$divid_next = $divid+1;
$arr['optionshtml'] = '<select name="cat_id_'. $divid .'" size=8 style="float:left;display:inline;margin-left:3px;" onchange="catsel_yshop100(this, '. $divid .')"><option value="0" style="background:#dce6f0;">请选择&nbsp;&nbsp;&nbsp;&nbsp;</option>'. $option_temp .'</select><div id="catsel'. $divid_next .'" style="float:left;display:inline;margin-left:3px;"></div>';
$arr['divid']    = $divid;
$arr['count'] =$j;
