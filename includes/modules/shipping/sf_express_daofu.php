...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/sf_express_daofu.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式插件的代码必须和文件名保持一致 */
    $modules[$i]['code']    = 'sf_express_daofu';

    $modules[$i]['version'] = '1.0.0';

    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'sf_express_daofu_desc';
...
/* 代码增加_start     */
	/* 配送方式是否支持门店自提 */
    $modules[$i]['support_pickup']     = false;
/* 代码增加_end     */
    /* 插件的作者 */
...
class sf_express_daofu
{
     ...
     * @return null
     */
    function sf_express_daofu($cfg = array())
    {
