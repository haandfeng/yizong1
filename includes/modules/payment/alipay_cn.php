...
class alipay_cn
{
    ...
    function get_code($order, $payment)
    {
		...
		$parameter['notify_url'] = 'http://www.quickact.net/respond.php?code=alipay_cn';//return_url(basename(__FILE__, '.php'));
		$parameter['return_url'] = 'http://www.quickact.net/respond.php?code=alipay_cn';
