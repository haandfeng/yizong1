...
class alipay_hk
{
    ...
    function get_code($order, $payment)
    {
		...
		$parameter['notify_url'] = 'http://www.quickact.net/respond-test.php?code=alipay_cn';//return_url(basename(__FILE__, '.php'));
		$parameter['return_url'] = 'http://www.quickact.net/respond-test.php?code=alipay_cn';
        ...
        $param = '';
        $sign  = '';
		RecordsFile( ROOT_PATH.'data/logs/','order-logs-payparameter-'.date('Y-m-d').'.txt',$parameter);
