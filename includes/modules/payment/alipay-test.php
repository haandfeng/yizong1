...
class alipay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $parameter = array(
            ...
            'notify_url'        => 'http://www.easebutech.com/respond_test.php',//return_url(basename(__FILE__, '.php')),
            'return_url'        => 'http://www.easebutech.com/respond_test.php',//return_url(basename(__FILE__, '.php')),
            /* 业务参数 */
		...
		//$parameter['sign'] = '';
		$parameter['notify_url'] = 'http://www.easebutech.com/respond_test.php';//return_url(basename(__FILE__, '.php'));
		$parameter['subject'] = $order['order_sn'];
		$parameter['out_trade_no'] = $order['order_sn'];
		//$parameter['currency'] = '';
		//$parameter['total_fee'] = '';
		//$parameter['order_gmt_create'] = date('Y-m-d H:i:s',time());
		//$parameter['order_valid_time'] = 3600;
		$parameter['body'] = 'test';
		$parameter['product_code'] = 'NEW_WAP_OVERSEAS_SELLER';
		$parameter['qr_pay_mode'] = 4;
		$parameter['qrcode_width'] = 200;
