...
if ($_REQUEST['act'] == 'add')
{
    ...
    $sql = "SELECT * FROM " .$ecs->table('suppliers') ." ORDER BY suppliers_id ASC";
...
elseif ($_REQUEST['act'] =='insert')
{
    ...
    $record = array('act_name'=>$_POST['package_name'], 'act_desc'=>$_POST['desc'],
                    ...
                    'end_time'=>$_POST['end_time'], 'is_finished'=>0, 'ext_info'=>serialize($info), 'suppliers_id'=>$_POST['suppliers_id']);
...
elseif ($_REQUEST['act'] =='update')
{
    ...
    $record = array('act_name' => $_POST['package_name'], 'start_time' => $_POST['start_time'], 'end_time' => $_POST['end_time'],
                    'act_desc' => $_POST['desc'], 'ext_info'=>serialize($info), 'suppliers_id'=>$_POST['suppliers_id']);
...
function get_packagelist()
{
    ...
    if ($result === false)
    {
        ...
        if (isset($_REQUEST['is_ajax']) && $_REQUEST['is_ajax'] == 1)
        {
            ...
            $filter['suppliers_id'] = json_str_iconv($filter['suppliers_id']);
        }
