 ...
 * $Author: yshop100.com $
 * $Id: users_export.php 17217 2013-01-19 06:29:08Z yshop100.com $
 */
...
elseif ($_REQUEST['act'] == 'act_export_excel')
{
	admin_priv('users_manage');
	 ...
	 $sql_yshop100_com = "select * from ". $GLOBALS['ecs']->table('user_rank');
	 $res_yshop100_com = $GLOBALS['db']->query($sql_yshop100_com);
	 while ($row_yshop100_com = $GLOBALS['db']-> fetchRow($res_yshop100_com))
	 {
		 if ($row_yshop100_com['special_rank'])
		 {
			$rank_list_www_com[$row_yshop100_com['rank_id']] = $row_yshop100_com['rank_name'];
		 }
		 else
		 {
			$rank_list_www_com[0][$row_yshop100_com['rank_id']] = array(
																							'rank_name' => $row_yshop100_com['rank_name'],
																							'min_points' => $row_yshop100_com['min_points'],
																							'max_points' => $row_yshop100_com['max_points']
																							);
		 }
	 }
