...
$modules['02_cat_and_goods']['13_price_add'] = 'goods_price.php?act=add'; // 商品批量gaijia
...
$modules['02_cat_and_goods']['26_kuajing_register'] = 'kuajing.php?act=list&t=goods';//zx 20200224
$modules['02_cat_and_goods']['goods_number_batch'] = 'goods_number_batch.php?act=add';
$modules['02_cat_and_goods']['goods_print'] = 'goods_print.php';
...
$modules['03_promotion']['07_pintuan'] = 'pintuan.php?act=list';
...
$modules['04_order']['02_pintuanorder_list'] = 'pintuan.php?act=view';
...
$modules['04_order']['07_order_wxbill'] = 'order.php?act=bill';
$modules['04_order']['07_order_quickbill'] = 'order.php?act=quick_pay';
$modules['04_order']['07_order_wxpay_query'] = 'order.php?act=order_query_pay';
$modules['04_order']['07_order_wxtlement'] = 'order.php?act=tlement';
...
/* 增值税发票_添加_START_www.yshop100.com */
$modules['04_order']['26_kuajing_order'] = 'kuajingorder.php?act=list&t=order';//zx 20200224

/* 虚拟卷订单列表_添加_START_www.yshop100.com */
...
$modules['06_stats']['stores_stats'] = 'stores_stats.php?act=list'; // 门店统计
// $modules['06_stats']['sellers_stats'] = 'sellers_stats.php?act=list'; // 导购员统计
...
$modules['08_members']['qiandao'] = 'qiandao.php';
...
$modules['10_priv_admin']['stores_list'] = 'stores.php?act=list';
$modules['10_priv_admin']['sellers_list'] = 'sellers.php?act=list';
