...
class cls_sql_dump
{
     ...
     */
    public static function get_head($path)  //代码修改   By    www.yshop100.com   增加 public static
    {
        /* 获取sql文件头部信息 */
     ...
     */
    public static function get_random_name()  //代码修改   By    www.yshop100.com
    {
        $str = date('Ymd');
