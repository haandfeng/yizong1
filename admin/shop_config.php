...
$auth = local_mktime(); //代码修改  By www.yshop100.com
...
if ($_REQUEST['act'] == 'list_edit')
{
    ...
    $smarty->assign('sms_num', GetBalance());
        ...
        if ((isset($file['error']) && $file['error'] == 0) || (!isset($file['error']) && $file['tmp_name'] != 'none'))
        {
            ...
            else
            {
                ...
                else
                {
              	...
              	/*生成商品默认图片缩略图  修改 start by www.yshop100.com */
...
elseif ($_REQUEST['act'] == 'send_test_email')
{
    ...
    $res = send_mail('', $email, $_LANG['test_mail_title'], $_LANG['cfg_name']['email_content'], 0);
    if ($res)
    {
    ...
    function GetBalance(){
        ...
        if($account && $password)
        {
            ...
            $argv = array( 
                 ...
                 'pwd'=>$password, //此处密码需要加密 加密方式为 md5(sn+password) 32位大写           
            ); 
            //构造要post的字符串 
