...
if ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('pickup_point')."(shop_name, address, contact, phone, province_id, ".
                "city_id, district_id, is_show) ".
            "VALUES ('$_POST[shop_name]', '$_POST[address]', '$_POST[contact]', '$_POST[phone]', ".
                "'$_POST[province]', '$_POST[city]', '$_POST[district]', '$_POST[is_show]')";
    $db->query($sql);
...
{
    if ($exc->edit("shop_name='$_POST[shop_name]', address='$_POST[address]', contact='$_POST[contact]', phone='$_POST[phone]', province_id='$_POST[province]', city_id='$_POST[city]', district_id ='$_POST[district]', is_show ='$_POST[is_show]'", $_POST['id']))
    {
...
elseif ($_REQUEST['act'] == 'toggle_is_show')
{
    ...
    if ($exc->edit("is_show = '$is_show'", $id))
    {
        clear_cache_files();
...
function get_pickup_point_list()
{
    ...
    if ($result === false)
    {
        ...
        $filter['is_show']   = empty($_REQUEST['is_show']) ? '' : trim($_REQUEST['is_show']);
        $where = '';
        ...
        {
            $where .= " AND is_show=" . $filter['district'];
        }
