...
// 权限对照表
    ...
    {
        $menus[$key]['label'] = '系统管理';
        
                $menus[$key]['children'][0]['label']  = '客户访问日志';
                $menus[$key]['children'][0]['action'] = '/admin/admin_iplogs.php?act=list';
                $menus[$key]['children'][1]['label']  = '管理员日志';
                $menus[$key]['children'][1]['action'] = '/admin/admin_logs.php?act=list';
                $menus[$key]['children'][2]['label']  = '关键字管理';
                $menus[$key]['children'][2]['action'] = '/admin/admin_keyword.php?act=list';
