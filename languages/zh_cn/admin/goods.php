...
$_LANG['sel_goods_type'] = '请选择商品类型';
$_LANG['sel_goods_contry'] = '请选择原产国';
$_LANG['sel_goods_unit'] = '请选择商品单位';
...
$_LANG['tax_id'] = '税率：';
$_LANG['tax_no'] = '不需税费';
$_LANG['tax_discount'] = '税费折扣：';
$_LANG['tax_config'] = '添加税率';

$_LANG['add'] = '增加';
$_LANG['subtract'] = '减少';
$_LANG['current_value'] = '当前值：';
$_LANG['lab_goods_number_change_desc'] = '库存变动原因：';
$_LANG['no_goods_number_change'] = '没有库存变动';
$_LANG['goods_number_change_ok'] = '商品库存变动成功';

$_LANG['js_languages']['no_change_desc'] = '请输入库存变动原因';
$_LANG['js_languages']['goods_number_not_int'] = '库存不是整数';
