...
$_LANG['price_batch'] = '批量修改价格'; // 代码增加 By www.yshop100.com
$_LANG['article_auto'] = '文章自动发布';
$_LANG['navigator'] = '自定义导航栏';
/* 虚拟团购 代码增加 by www.yshop100.com start */
...
/* 虚拟团购 代码增加 by www.yshop100.com end */
$_LANG['goods_number_edit'] = '商品库存修改';
$_LANG['goods_number_batch'] = '商品批量导入库存';
$_LANG['goods_print'] = '商品标签打印';
...
$_LANG['07_order_wxbill'] = '微信对账单（宜众）';
$_LANG['07_order_quickbill'] = '快闪付对账单';
$_LANG['07_order_wxpay_query'] = '订单查询（微信）';
$_LANG['07_order_wxtlement'] = '结算资金（微信）';
$_LANG['02_pintuanorder_list'] = '拼团订单';
$_LANG['07_order_shenbao'] = '海关申报';
...
$_LANG['stores_stats'] = '门店统计';
$_LANG['sellers_stats'] = '导购员统计';
...
$_LANG['04_users_export'] = '会员导出'; // 代码增加 By www.yshop100.com
...
$_LANG['stores_list'] = '门店列表';
$_LANG['sellers_list'] = '导购员列表';
...
/* 代码增加_end By supplier.yshop100.com */
// 微信管理 增加 start by www.yshop100.com 微商城
...
// 增加 end by www.yshop100.com 微商城
...
/* 代码增加_zx20200224 */
$_LANG['26_kuajing_register'] = '跨境商品备案';
$_LANG['26_kuajing_order'] = '跨境订单管理';
?>