...
$_LANG['alipay_pay_currency'] = '支付货币类型：';
$_LANG['alipay_pay_currency_desc'] = '此项仅在选择境外接口时才会生效；填写一种货币用来做支付标准 如：HKD、USD....   如果商品设置的是港币的价格此处就填写"HKD"';
...
$_LANG['alipay_pay_method_range'][3] = '境外支付接口（港币）';
?>